...
class Auth extends BaseController
{
    ...
    public function login()
    {
        ...
        return view('user/login_page', $data);
    }
    ...
    public function form_register()
    {
        ...
        return view('user/register_page', $data);
    }
    ...
    private function _sendConfirmationEmail($userEmail)
    {
        ...
        $email->setFrom('diimass.h@gmail.com', 'Registration Confirmation');
    ...
    public function activate($token)
    {
        ...
        if ($user) {
            ...
            echo "<h3> Akun Anda Sudah Pernah diaktifkan<a href=" . base_url() . "/login> Kembali</a></h3>";
        } else {
    ...
    {
        return view('user/lupa_password');
    }
    ...
    private function _sendNewPasswordEmail($userEmail, $username, $newPassword)
    {
        ...
        $email->setFrom('diimass.h@gmail.com', 'Reset Password');
        $email->setTo($userEmail);
    ...
    public function proses_ganti_password()
    {
        ...
        if ($updated) {
            return redirect()->to('/profil')->with('pesan', 'Password successfully changed.');
        } else {
