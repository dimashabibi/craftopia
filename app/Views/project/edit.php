...
<div class=container>
    <div class=row-center>
        <div class=col-8>
            ...
            <br>
            <!-- Form Input Data -->
            <form action="/project/update/<?= $project['id']; ?>" method="post" class="my-3" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                ...
                <div class="col-10">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('judul')) ? 'is-invalid' : ''; ?>" id="judul" aria-describedby="judul" name="judul" placeholder="Masukkan Judul" value="<?= (old('judul')) ? old('judul') : $project['judul']; ?>" autofocus>
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('penulis')) ? 'is-invalid' : ''; ?>" id="penulis" aria-describedby="penulis" name="penulis" placeholder="Masukkan Nama" value="<?= (old('penulis')) ? old('penulis') : $project['penulis']; ?>">
                    ...
                    <div class="col-12 mt-3">
                        ...
                        <textarea type="text" class="form-control" id="deskripsi" placeholder="Input Deskripsi" name="deskripsi"><?= (old('deskripsi')) ? old('deskripsi') : $project['deskripsi']; ?></textarea>
                    </div>
                        ...
                        <div class="mt-1 row g-3">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="pinterest" placeholder="craftopia_" aria-label="Text input with checkbox" value="<?= (old('pinterest')) ? old('pinterest') : $project['pinterest']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="instagram" placeholder="craftopia_" aria-label="Text input with checkbox" value="<?= (old('instagram')) ? old('instagram') : $project['instagram']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="facebook" placeholder="craftopia_" aria-label="Text input with checkbox" value="<?= (old('facebook')) ? old('facebook') : $project['facebook']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tiktok" placeholder="craftopia_" aria-label="Text input with checkbox" value="<?= (old('tiktok')) ? old('tiktok') : $project['tiktok']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-sm-3">
                                <p><b>Preview</b></p>
                                <img src="/img/<?= $project['gambar']; ?>" class="img-thumbnail img-preview">
                            </div>

                            <div class="col-sm-9">
                                <label for="gambar" class="form-label ms-2"><b>Pilih Gambar</b></label>
                                <div class="col-10">
                                    <input class="form-control" style="margin-top: 80px;" type="file" id="gambar" name="gambar" value="<?= (old('gambar')) ? old('gambar') : $project['gambar']; ?>" onchange="previewImg()">
                                </div>
                            </div>
                        </div>
                    </div>
