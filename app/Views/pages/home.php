        ...
        <div class="col-lg-8">
            <a href="/article_home">
                ...
                <div class="card text-bg-dark">
                    <img src="<?= base_url('img/rajut.png'); ?>" class="card-img" alt="rajut">
                    <div class="card-img-overlay">
                        <div class="card text-bg-light mb-3 float-end">
                            <div class="card-body">
                                <h5 class="card-title">Article</h5>
                                <p class="card-text">Teknik Dasar menyulam !</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="text-center mt-4">
                <p class="fs-5">Welcome to craftopia, your home to find inspiration on how to make handicrafts
                    for yourself or for your loved ones around you.</p>
            </div>
            <br><br>
        </div>
