...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url('bootstrap/assets/vendor/css/pages/page-misc.css'); ?>" />
    <!-- Helpers -->
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            <h2 class="mb-2 mx-2">Page Still under development :'(</h2>
            <p class="mb-4 mx-2">Oops! 😖 The requested URL is under development.</p>
            <a href="/" class="btn btn-primary">Back to home</a>
            <div class="mt-4">
                <img src="<?= base_url('bootstrap/assets/img/illustrations/girl-doing-yoga-light.png'); ?>" alt="girl-doing-yoga-light" width="500" class="img-fluid" data-app-dark-img="illustrations/girl-doing-yoga-dark.png" data-app-light-img="illustrations/girl-doing-yoga-light.png" />
            </div>
        </div>
    </div>
    <!-- /Error -->
